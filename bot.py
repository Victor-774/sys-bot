...
IMAGE_URL_MENU = "https://imgur.com/LtfSeD3"
IMAGE_URL_COPYWRITTING = "https://imgur.com/y8VWc43"
IMAGE_URL_REWRITTING = "https://imgur.com/OwoexH3"
IMAGE_URL_RANDOMIZE = "https://imgur.com/aHHU57S"
IMAGE_URL_KEYWORDS = "https://imgur.com/KAzBGTJ"
IMAGE_URL_HEADLINES = "https://imgur.com/D9d8Wtm"
IMAGE_URL_ADDITIONAL = "https://imgur.com/DZnY8oY"
IMAGE_URL_VERIFICATION = "https://imgur.com/EHb9ck9"
IMAGE_URL_PROMOTION = "https://imgur.com/YRVHurm"
IMAGE_URL_SUPPORT = "https://imgur.com/M5QSipV"
...
async def start_handler(message: types.Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="Проверить подписку", callback_data="already_subscribed")]
    ])

    await message.answer("Для использования бота сначала подпишитесь на канал", reply_markup=keyboard)
...
async def subscribe_handler(callback: CallbackQuery):
    ...
    message = await bot.send_message(callback.message.chat.id, "Давай проверим подписку")

    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="Проверить подписку", callback_data="check_subscription")]
    ])

    await bot.edit_message_text(chat_id=callback.message.chat.id, message_id=message.message_id, text="Давай проверим подписку", reply_markup=keyboard)
...
async def check_subscription_handler(callback: CallbackQuery):
    ...
    if await check_subscription(user_id):
        ...
        await bot.send_message(callback.message.chat.id, "Друг, надо подписаться", reply_markup=keyboard)
...
async def callback_handler(callback: CallbackQuery, state: FSMContext):
    ...
    if action in AGENTS:
        ...
        messages = {
            ...
            "randomize": "Отправьте текст для рандомизации.",
